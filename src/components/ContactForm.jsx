      ...
      {step === 'input' ? (
        <>
          <label className="home-contact-form__row">
            <span>お名前</span>
            <input type="text" name="name" value={values.name} onChange={handleChange} autoComplete="name" required />
          </label>

          <label className="home-contact-form__row">
            <span>メールアドレス</span>
            <input type="email" name="email" value={values.email} onChange={handleChange} autoComplete="email" required />
          </label>

          <div className="home-contact-form__row">
            <span>電話番号</span>
            <div className="home-contact-form__phone">
              <input type="tel" name="phone1" value={values.phone1} onChange={handleChange} inputMode="numeric" autoComplete="tel-area-code" aria-label="電話番号の最初の欄" />
              <i aria-hidden>−</i>
              <input type="tel" name="phone2" value={values.phone2} onChange={handleChange} inputMode="numeric" autoComplete="tel-local-prefix" aria-label="電話番号の中央の欄" />
              <i aria-hidden>−</i>
              <input type="tel" name="phone3" value={values.phone3} onChange={handleChange} inputMode="numeric" autoComplete="tel-local-suffix" aria-label="電話番号の最後の欄" />
            </div>
          </div>
